...
namespace StudentManagementSystem.Controllers
{
    public class StudentController : Controller
    {
        ...
        private readonly string _connectionString = @"Data Source=(localdb)\ProjectsV13;Initial Catalog=School;
        ...
        {
            string quearyString = @"INSERT INTO Students (FirstName, LastName) VALUES (@FirstName, @LastName)";
